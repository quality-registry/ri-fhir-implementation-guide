...
| Medication | [Medications ValueSet](ValueSet-medications-vs.html), [DischargeMedication ValueSet](ValueSet-discharge-medication-vs.html), [NotMedicationReason ValueSet](ValueSet-not-medication-reason-vs.html), [AdherenceCodes ValueSet](ValueSet-adherence-codes-vs.html), [DoseFormUnit ValueSet](ValueSet-dose-form-unit-vs.html), [MedicationDosageWhen ValueSet](ValueSet-medication-dosage-when-vs.html) |
