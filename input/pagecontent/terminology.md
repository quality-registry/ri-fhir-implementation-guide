...
| Derived values | [SelfReportedValueAggregation ValueSet](ValueSet-self-reported-value-aggregation-vs.html), [SelfReportedAggregationStatus ValueSet](ValueSet-self-reported-aggregation-status-vs.html), [SelfReportedReadingStatus ValueSet](ValueSet-self-reported-reading-status-vs.html), [GlucoseRiskStatus ValueSet](ValueSet-glucose-risk-status-vs.html), [CholesterolRiskStatus ValueSet](ValueSet-cholesterol-risk-status-vs.html) |
