...
| Medication | [Medications ValueSet](ValueSet-medications-vs.html), [NotMedicationReason ValueSet](ValueSet-not-medication-reason-vs.html), [AdherenceCodes ValueSet](ValueSet-adherence-codes-vs.html), [DoseFormUnit ValueSet](ValueSet-dose-form-unit-vs.html), [MedicationDosageWhen ValueSet](ValueSet-medication-dosage-when-vs.html) |
| Derived values | [SelfReportedValueAggregation ValueSet](ValueSet-self-reported-value-aggregation-vs.html), [AveragingWindow ValueSet](ValueSet-averaging-window-vs.html), [SelfReportedAggregationStatus ValueSet](ValueSet-self-reported-aggregation-status-vs.html), [SelfReportedReadingStatus ValueSet](ValueSet-self-reported-reading-status-vs.html), [BloodPressureRiskStatus ValueSet](ValueSet-blood-pressure-risk-status-vs.html), [GlucoseRiskStatus ValueSet](ValueSet-glucose-risk-status-vs.html), [CholesterolRiskStatus ValueSet](ValueSet-cholesterol-risk-status-vs.html) |
