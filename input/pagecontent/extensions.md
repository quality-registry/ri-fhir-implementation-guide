...
| [Averaging window](StructureDefinition-averaging-window-ext.html) | `Observation` | States which fixed look-back window an aggregated value expresses: 7, 14 or 30 days. |
