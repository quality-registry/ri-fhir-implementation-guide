...
* ^url = "http://fhir.qualityregistry.org/StructureDefinition/stroke-imaging-diagnostic-report-profile"
...
* ^url = "http://fhir.qualityregistry.org/StructureDefinition/mechanical-thrombectomy-diagnostic-report-profile"
* insert RESQProfileMetadata
