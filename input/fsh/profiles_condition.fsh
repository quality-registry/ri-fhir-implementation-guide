...
* ^url = "http://fhir.qualityregistry.org/StructureDefinition/stroke-diagnosis-condition-profile"
...
Severity: #error
Expression: "extension.where(url = 'http://fhir.qualityregistry.org/StructureDefinition/ischemic-stroke-etiology-ext').exists().not() or code.coding.where(system = 'http://snomed.info/sct' and code = '422504002').exists()"
...
Severity: #error
Expression: "extension.where(url = 'http://fhir.qualityregistry.org/StructureDefinition/hemorrhagic-stroke-bleeding-reason-ext').exists().not() or code.coding.where(system = 'http://snomed.info/sct' and (code = '274100004' or code = '21454007')).exists()"
...
Severity: #warning
Expression: "extension.where(url = 'http://fhir.qualityregistry.org/StructureDefinition/wakeup-stroke-ext').value.ofType(boolean) != true or onset.exists()"
...
Severity: #error
Expression: "code.memberOf('http://fhir.qualityregistry.org/ValueSet/mimics-diagnosis-vs').not() or (extension.where(url = 'http://fhir.qualityregistry.org/StructureDefinition/ischemic-stroke-etiology-ext').exists().not() and extension.where(url = 'http://fhir.qualityregistry.org/StructureDefinition/hemorrhagic-stroke-bleeding-reason-ext').exists().not())"
...
* ^url = "http://fhir.qualityregistry.org/StructureDefinition/stroke-risk-factor-condition-profile"
* insert RESQProfileMetadata
...
* ^url = "http://fhir.qualityregistry.org/StructureDefinition/post-stroke-complication-condition-profile"
* insert RESQProfileMetadata
