...
* ^url = "http://tecnomod-um.org/StructureDefinition/patient-reported-outcome-questionnaire-responses"
...
Severity: #error
Expression: "item.all(answer.exists() or extension('http://tecnomod-um.org/StructureDefinition/questionnaire-skipped-item-ext').exists())"
...
Severity: #error
Expression: "questionnaire in ('http://tecnomod-um.org/Questionnaire/mrs-questionnaire' | 'http://tecnomod-um.org/Questionnaire/phq9-questionnaire' | 'http://tecnomod-um.org/Questionnaire/sf-sis-questionnaire' | 'http://tecnomod-um.org/Questionnaire/sf-neadl-questionnaire')"
